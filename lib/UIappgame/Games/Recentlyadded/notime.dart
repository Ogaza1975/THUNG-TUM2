...
class Notimetorelax extends StatefulWidget {
  @override
  _NotimetorelaxState createState() => _NotimetorelaxState();
}

class _NotimetorelaxState extends State<Notimetorelax> {
  final PageController _pageController = PageController(viewportFraction: 0.55);

  final List<String> imagePaths = [
    'assets/images/notime.png',
    'assets/images/notime2.jpg',
    'assets/images/notime3.jpg',
    'assets/images/notime4.jpg',
  ];
  ...
  Future<void> _loadFavoriteStatus() async {
    ...
    setState(() {
      _isFavorite = prefs.getBool('favorite_no_time_to_relax') ?? false;
    });
  }
  ...
  Future<void> _toggleFavorite() async {
    ...
    setState(() {
      ...
      prefs.setBool('favorite_no_time_to_relax', _isFavorite);
    });
  }
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'No Time to Relax เป็นเกมจำลองชีวิตที่ผู้เล่นสูงสุด 4 คนสามารถแข่งขันกันทางออนไลน์หรือเฉพาะในเครื่องในสุดยอดเกมใช้ชีวิต',
              ...
              _isDescriptionExpanded
                  ? const Column(
                    ...
                    children: [
                      Text(
                        'เล่นออนไลน์กับเพื่อนของคุณ (หรือกับคนแปลกหน้าล้วนๆ)',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'ผู้เล่นคนเดียว vs ผู้เล่น CPU (Skynet ระวังตัวให้ดี!)',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                        'ทำภารกิจให้เสร็จสิ้น สาปเพื่อนของคุณ แล้วรับสัตว์ไปเลี้ยงสักตัวจะได้ถือไพ่เหนือกว่า',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'ทำภารกิจให้เสร็จสิ้น สาปเพื่อนของคุณ แล้วรับสัตว์ไปเลี้ยงสักตัวจะได้ถือไพ่เหนือกว่า',
                      ...
                      SizedBox(height: 10),
                      Text(
                        'ตกแต่งอพาร์ทเมนต์คุณด้วยของราคาถูกและของตกแต่งหรูๆ',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'ให้การศึกษาแก่ตัวละครของคุณ รับประสบการณ์ทำงาน และลงเล่นในตลาดหุ้น',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                        'เล่นในโหมดสงบสุขเพื่อประสบการณ์การเล่นที่เครียดน้อยลง ไม่มีคำสาป',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                      ...
                      SizedBox(height: 10),
                      Text(
                        'เลือกจากรูปแทนตัว 7 แบบที่แตกต่างกัน',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'ซาวด์แทร็กประกอบเพลงเจ๋งๆ',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                    ],
                  )
