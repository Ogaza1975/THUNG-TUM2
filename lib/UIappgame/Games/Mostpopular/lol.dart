...
class _LolState extends State<Lol> {
  ...
  final List<String> imagePaths = [
    ...
    'assets/images/lol3.jpg',
    'assets/images/lol4.jpg',
    'assets/images/lol5.jpg',
  ];
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'League of Legends: สู่สมรภูมิแห่งความท้าทาย ที่คุณจะได้เป็นตำนาน',
                style: TextStyle(
              ...
              const SizedBox(height: 12),
              const Text(
                'เตรียมตัวให้พร้อม! เข้าสู่โลกแห่ง Runeterra ดินแดนที่เต็มไปด้วยความขัดแย้งและเวทมนตร์ ที่นี่ คุณจะได้พบกับเหล่าแชมเปี้ยนผู้กล้าหาญและเปี่ยมด้วยพลังพิเศษ ที่พร้อมจะนำคุณเข้าสู่สมรภูมิรบอันดุเดือด League of Legends (LoL) ไม่ใช่แค่เกม แต่เป็น "ประสบการณ์" ที่จะพาคุณดำดิ่งสู่โลกแห่งการแข่งขัน ที่คุณจะได้ใช้กลยุทธ์ ไหวพริบ และความสามารถเฉพาะตัว เพื่อเอาชนะคู่ต่อสู้และก้าวสู่จุดสูงสุดของการเป็นตำนาน',
              ...
              _isDescriptionExpanded
                  ? const Column(
                    ...
                    children: [
                      Text(
                        'ทำไมคุณถึงควรลองเล่น League of Legends',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'แชมเปี้ยนหลากหลาย: พบกับแชมเปี้ยนกว่า 160 ตัว ที่มีทักษะ ความสามารถ และสไตล์การเล่นที่แตกต่างกัน คุณสามารถเลือกแชมเปี้ยนที่เหมาะกับสไตล์การเล่นของคุณ และฝึกฝนจนเชี่ยวชาญ',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                      ...
                      Text(
                        'ร่วมมือกับเพื่อนร่วมทีม 4 คน เพื่อวางแผนกลยุทธ์ และเอาชนะทีมฝั่งตรงข้าม การทำงานเป็นทีมเป็นสิ่งสำคัญมากใน LoL',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                      ...
                      Text(
                        'LoL เป็นเกมที่มีความท้าทายสูง คุณต้องเรียนรู้และปรับตัวอยู่ตลอดเวลา เพื่อรับมือกับคู่ต่อสู้ที่แข็งแกร่งขึ้นเรื่อย ๆ',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                      ...
                      Text(
                        'LoL เป็นเกมที่มีการแข่งขันระดับโลก คุณสามารถเข้าร่วมการแข่งขัน และแสดงความสามารถของคุณให้โลกได้รับรู้',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                    ],
                  )
