...
import 'package:flutter_application_7/wordgame.dart';
...
class _wordgameState extends State<wordgame> {
  ...
  final List<String> imagePaths = [
    'assets/images/wordgame1.png',
    'assets/images/wordgame2.png',
    'assets/images/wordgame3.png',
    'assets/images/wordgame4.png',
  ];
  ...
  Future<void> _loadFavoriteStatus() async {
    ...
    setState(() {
      _isFavorite = prefs.getBool('favorite_wordgame') ?? false;
    });
  }
  ...
  Future<void> _toggleFavorite() async {
    ...
    setState(() {
      ...
      prefs.setBool('favorite_wordgame', _isFavorite);
    });
  }
                          ...
                          Stack(
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/icon_wordgame.webp',
                                  width: 100,
                                  height: 100,
                                  fit: BoxFit.cover,
                                ),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'WordGame – เกมทายคำศัพท์สุดท้าทาย ฝึกไหวพริบและทักษะภาษาอังกฤษ!',
                style: TextStyle(color: Colors.white, fontSize: 18),
              ),
              const SizedBox(height: 12),
              const Text(
                'WordGame เป็นเกมที่จะช่วยให้คุณฝึกทักษะด้านคำศัพท์ภาษาอังกฤษ พร้อมทั้งทดสอบไหวพริบและความสามารถในการจัดเรียงตัวอักษรของคุณ! ตัวเกมออกแบบมาให้เล่นง่าย แต่ก็แฝงไปด้วยความท้าทายที่ทำให้คุณต้องคิดและใช้ความรู้ทางภาษาของตัวเองให้เต็มที่',
              ...
              _isDescriptionExpanded
                  ? const Column(
                    ...
                    children: [
                      ...
                      Text(
                        '1.ระบบจะทำการสุ่มตัวอักษรภาษาอังกฤษจำนวนหนึ่งขึ้นมาให้คุณ',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                        '2.ผู้เล่นต้องนำตัวอักษรเหล่านั้นมาจัดเรียงเป็นคำที่มีความหมาย',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      SizedBox(height: 10),
                      Text(
                      ...
                      SizedBox(height: 10),
                      Text(
                        'WordGame ไม่ได้เป็นแค่เกมเล่นสนุก แต่ยังเป็นเครื่องมือฝึกฝนทักษะภาษาอังกฤษที่ยอดเยี่ยม ไม่ว่าจะเป็นการพัฒนาคลังคำศัพท์ การฝึกสะกดคำ หรือแม้กระทั่งการฝึกความคิดสร้างสรรค์ในการจับคู่ตัวอักษรให้เกิดเป็นคำที่มีความหมาย',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                      Text(
                        'มาท้าทายตัวเองและพัฒนาทักษะทางภาษาของคุณไปกับ WordGame – เกมเรียงคำศัพท์สุดมันส์! 🔠✨',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                      ),
                    ],
                  )
